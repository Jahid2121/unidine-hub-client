      ...
      <Navbar>
        <div className="mt-20 w-full mx-auto  text-white">
          <div className="grid grid-cols-12  min-h-screen">
            <div className="md:col-span-1   col-span-12 flex md:flex-col flex-row  dashNav sticky md:static z-20 top-20 gap-10 md:gap-5 items-center p-4 md:pt-12 bg-customGreen">
              {isAdmin ? 
                <>
                  {/* admin */}
                  <DashboardLink className="flex items-center text-white" to="/dashboard/profile">
                     <span className="dash-icon ">
                      <svg className="hover:animate-spin" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 448 512">
                  ...
                  > 
                  <span className="dash-icon">
                  <svg className="hover:animate-spin" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                  ...
                  >
                    <span className="dash-icon">
                    <svg fill="white" className="hover:animate-spin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  ...
                  >
                    <span className="dash-icon">
                    <svg className="hover:animate-spin" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
               ...
               : 
                <div className="flex flex-row md:flex-col  gap-14 md:gap-2  mx-auto md:mx-2">
                  ...
                  <span className="dash-icon"><BsPersonCircle /></span>
            ...
            <div className="md:col-span-12 ml-20 pl-6 col-span-12 text-center pt-20 bg-gray-200 text-black">
              <Outlet />
            </div>
          </div>
        </div>
